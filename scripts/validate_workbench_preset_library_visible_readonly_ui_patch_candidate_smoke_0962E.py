...
CODE='0962E'
TITLE='WORKBENCH_PRESET_LIBRARY_VISIBLE_READONLY_UI_PATCH_CANDIDATE_SMOKE'
SLUG='workbench_preset_library_visible_readonly_ui_patch_candidate_smoke_0962E'
EXPECTED_STATUS='PASS'
PREFIX=f"{CODE}_{TITLE}_"
MARKER='ALL_0962E_WORKBENCH_PRESET_LIBRARY_VISIBLE_READONLY_UI_PATCH_CANDIDATE_SMOKE_CHECKS_OK'
