...
CODE='0962F'
TITLE='WORKBENCH_PRESET_LIBRARY_VISIBLE_READONLY_APPLY_OR_HOLD_GATE'
SLUG='workbench_preset_library_visible_readonly_apply_or_hold_gate_0962F'
EXPECTED_STATUS='PASS'
PREFIX=f"{CODE}_{TITLE}_"
MARKER='ALL_0962F_WORKBENCH_PRESET_LIBRARY_VISIBLE_READONLY_APPLY_OR_HOLD_GATE_CHECKS_OK'
